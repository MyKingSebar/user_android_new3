...
public class SignUpDelegate extends LatteDelegate implements ITimeListener {
    ...
    @BindView(R2.id.edit_logup_password)
    TextInputEditText mPassword = null;

//    @BindView(R2.id.tl_logup_phone)
//    TextInputLayout mPhoneL = null;
//    @BindView(R2.id.tl_logup_note)
//    TextInputLayout mNoteL = null;
//    @BindView(R2.id.tl_logup_password)
//    TextInputLayout mPasswordL = null;
...
//            mPasswordL.setError("请填写至少6位数密码");
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        ...
        mTextWatcher=new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(!TextUtils.isEmpty(mPhone.getText().toString())&&!TextUtils.isEmpty(mPassword.getText().toString())&&!TextUtils.isEmpty(mNote.getText().toString())){
